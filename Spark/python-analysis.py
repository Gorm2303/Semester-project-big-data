...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"An error occurred while creating a Spark session: {str(e)}", file=sys.stderr)
        sys.exit(-1)
    ...
    try:
        ...
        print(f"An error occurred while reading the data: {str(e)}", file=sys.stderr)
        sys.exit(-1)
    ...
    try:
        ...
        print(f"An error occurred while writing the data: {str(e)}", file=sys.stderr)
        sys.exit(-1)
